# Composite Numerical Integration (CNI) using Mathematica
...
Using the Mathematica, we computed composite numerical integration over a quadrilateral region. We described the composite numerical integration over an arbitrary quadrilateral region in our following paper:
...
## Run
### Example 2 of Islam and Hossain (2009) 
